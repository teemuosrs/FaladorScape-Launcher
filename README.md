...
START
  ...
  launch: <runtime>\bin\javaw.exe -Djna.boot.library.path=<app> -Djna.nounpack=true \
          -Dsun.java2d.uiScale=1 -Dsun.java2d.uiScale.enabled=false -jar RSCMultiClient.jar
